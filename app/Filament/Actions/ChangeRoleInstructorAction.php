...
/**
 * ChangeRoleUserAction extends ChangeRoleAction to specifically change role to instructor.
 * 
 * @see \App\Filament\Actions\ChangeRoleAction
 * 
 * @package \App\Filament\Actions
 */
class ChangeRoleInstructorAction extends ChangeRoleAction
{
