...
<body class="antialiased font-sans dark:bg-gray-900 dark:text-white overflow-x-clip">
    ...
    <header class="header-section text-white text-center py-20 container mx-auto dark:bg-gray-800">
        ...
        <p class="text-xl mb-6">{{ __('The ultimate platform to learn English efficiently and effectively') }}</p>
    ...
    <section id="about" class="container mx-auto p-8">
        ...
        <p>{{ __('At :name, we are dedicated to providing top-notch English learning resources tailored to your needs. Our platform is designed to be user-friendly, interactive, and engaging, ensuring you have the best learning experience possible.', ['name' => config('app.name', 'Enlearn')]) }}
        </p>
    </section>
    ...
    <footer
        ...
        <p>&copy; 2025 {{ config('app.name', 'Enlearn') }}: English Learn. {{ __('All rights reserved.') }}</p>
    </footer>
</body>
